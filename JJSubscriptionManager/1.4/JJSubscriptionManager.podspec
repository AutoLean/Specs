Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/jeffreyjackson/JJSubscriptionManager.git", :tag => "1.4" }
  s.source_files = 'SubscriptionManager/SubscriptionManager/*.{h,m}'
  s.requires_arc = true
  s.platform     = :ios
  s.dependency 'RMStore'
  s.dependency 'OpenSSL-Universal', :git => 'https://github.com/krzyzanowskim/OpenSSL.git', :branch => :master
